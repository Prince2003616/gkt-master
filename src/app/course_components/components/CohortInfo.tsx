...
const CohortInfo: React.FC = () => {
  return (
    <div className="flex space-x-8 p-10 px-6">
      <div className="p-6 bg-gray-100 rounded-lg shadow-md w-1/4">
        <h2 className="text-sm font-medium text-gray-600">Course Title</h2>
